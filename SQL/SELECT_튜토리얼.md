...
이 SQL 튜토리얼에서는 구문, 예제 및 [연습 문제](https://github.com/riz-jeong/TechOnTheNet-Korean-Translation/blob/master/SQL/SELECT_연습문제.md)를 통해 SQL SELECT 문을 사용하는 방법을 설명합니다.
...
### [연습 문제로 이동](https://github.com/riz-jeong/TechOnTheNet-Korean-Translation/blob/master/SQL/SELECT_연습문제.md)